...
## 11. Bot tokenlari va maxfiy sozlamalar

Bot tokenlari va boshqa maxfiy ma’lumotlar **kod ichida yozilmaydi**. Tavsiya etilgan yondashuv:

- Tokenlarni **environment variable** orqali saqlash (masalan, `TELEGRAM_BOT_TOKEN`).
- Lokal rivojlantirishda `.env` fayli ishlatilishi mumkin, lekin u **git’ga kiritilmaydi**.
- Prod muhitida esa secret manager yoki CI/CD secrets orqali beriladi.
